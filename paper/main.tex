...
The clearest open question is whether per-edge routing can be adapted to the informative-heterophily regime---where CSNA currently fails---possibly by learning to leverage rather than suppress cross-class signal.
